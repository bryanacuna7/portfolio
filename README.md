...
My approach blends **analytical thinking** with **hands-on execution**, using tools like **SQL**, **Power BI**, **Tableau**, and **Excel** to transform complex financial data into actionable business insights.  
...
🌱 Currently exploring **AI-driven automation**, **data science**, and **predictive analytics** to integrate intelligent systems into financial operations and enhance business performance.  
In addition, I’m currently learning **JavaScript (JS)** and **Apex** to strengthen my skills in automation, integration, and Salesforce customization.  
